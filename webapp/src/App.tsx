...
export default function App() {
  ...
  const { error, isLoading, isTracking, handleGetLocation, finishedTripId } = useTracking();
    ...
    <div className="flex flex-col items-center min-h-screen bg-gray-900 text-white p-4">
      ...
      <div className="bg-gray-800 p-8 rounded-xl shadow-lg max-w-md w-full text-center mt-4 z-10">
        ...
        <button
          ...
          disabled={isLoading}
          className={`w-full font-bold py-3 px-6 rounded-lg transition-colors mb-6 shadow-md text-lg disabled:opacity-50 ${
            isTracking 
